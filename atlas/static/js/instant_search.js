(function () {
  ...
  var hAjx = null;
  d.getElementById('search').addEventListener(
    'input',
    instant_search.debounce(250),
  );
  d.getElementById('search-form').addEventListener('submit', (e) =>
    e.preventDefault(),
  );
  ...
  function instant_search(page) {
    ...
    d.getElementById('search')
      ...
      .setAttribute('href', '/search/query/' + search_text);
