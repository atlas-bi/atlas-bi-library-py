var module = (function () {
	...
	function requireEntities () {
		if (hasRequiredEntities) return entities.exports;
	...
	function requireMarkdownIt () {
		if (hasRequiredMarkdownIt) return markdownIt.exports;
	...
	function requireMarkdownItClass () {
		if (hasRequiredMarkdownItClass) return markdownItClass;
		...
		markdownItClass = markdownitTagToClass;
	...
	(function () {
	  ...
	  function Loader(b) {
	    ...
	    this.md = markdownIt.use(requireMarkdownItClass(), mapping);
