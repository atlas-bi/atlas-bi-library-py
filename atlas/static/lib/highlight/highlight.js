/*! highlight.js v9.17.0 | BSD3 License | git.io/hljslicense */ !(function (e) {
      ...
      n +=
        ...
        u.map
          .call(e.attributes, function (e) {
            return (
              " " + e.nodeName + '="' + M(e.value).replace(/"/g, "&quot;") + '"'
            );
          })
          .join("") +
        ">";
  ...
  function B(t, i, n, e) {
      ...
      (m +=
        null != p.sL
          ? (function () {
              ...
              var t = e
                ? B(p.sL, g, !0, f[p.sL])
                : R(g, p.sL.length ? p.sL : void 0);
              return (
                0 < p.relevance && (_ += t.relevance),
                e && (f[p.sL] = t.top),
          ...
          : (function () {
              var e, t, r, a, n, i, s;
              if (!p.k) return M(g);
              for (a = "", t = 0, p.lR.lastIndex = 0, r = p.lR.exec(g); r; )
                (a += M(g.substring(t, r.index))),
                  (n = p),
                  (i = r),
                  void 0,
    ...
    function d(e) {
      ...
      return (
        ...
        r.skip ? (g += t) : (r.eB && (g += t), o(), r.rB || r.eB || (g = t)),
        l(r),
        r.rB ? 0 : t.length
      );
    }
    ...
    function r(e, t) {
      ...
      if (
        ...
        return (g += i.slice(t.index, t.index + 1)), 1;
      if ("begin" === (u = t).type) return d(t);
      if ("illegal" === t.type && !n)
        throw new Error(
          'Illegal lexeme "' + r + '" for mode "' + (p.cN || "<unnamed>") + '"'
        );
      if ("end" === t.type) {
        var a = (function (e) {
          var t = e[0],
          ...
          if (a) {
            ...
            for (
              n.skip
                ? (g += t)
                : (n.rE || n.eE || (g += t), o(), n.eE && (g = t));
              p.cN && (m += k),
                p.skip || p.sL || (_ += p.relevance),
                (p = p.parent) !== a.parent;

            );
            return (
              a.starts &&
                (a.endSameAsBegin && (a.starts.eR = a.eR), l(a.starts)),
              n.rE ? 0 : t.length
            );
          }
        })(t);
    ...
    var g = "",
      _ = 0;
    try {
      for (var h, v, y = 0; (p.t.lastIndex = y), (h = p.t.exec(i)); )
        (v = r(i.substring(y, h.index), h)), (y = h.index + v);
  ...
  function h(e) {
    return E.tabReplace || E.useBR
      ? e.replace(r, function (e, t) {
          return E.useBR && "\n" === e
            ? "<br>"
            : E.tabReplace
            ? t.replace(/\t/g, E.tabReplace)
            : "";
        })
      : e;
  }
